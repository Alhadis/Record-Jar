(function(){
	...
	RecordJar.prototype = {
		...
		/**
		 * Break a stream of text apart into records and pushes the results onto the RecordJar's .records array.
		 *
		...
		/**
		 * Add one or more objects to the RecordJar's .records array.
		 *
		...
		/**
		 * Recompile the text-based representation of the RecordJar.
		 *
		 * @return {String}
		 */
		toString: function(){
			...
			var maxLength = THIS.maxLineLength;
			var r, j, f, field;
